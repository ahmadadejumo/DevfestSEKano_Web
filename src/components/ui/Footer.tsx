    ...
    <footer className="bg-black mt-10 p-6 md:flex md:justify-between">
      <div className="flex flex-col md:flex-row md:justify-between w-full">
        ...
        <div className="flex justify-center gap-6 md:gap-2 w-full md:w-[66.6%] md:justify-evenly md:items-center md:flex-row-reverse">
          {/* Third Column */}
          <div>
            <h3 className="text-white text-center tex-[0.875rem] text-style font-semibold mb-2 leading-normal">
              Follow us on:
            </h3>
          ...
          <div className="mb-4">
            <ul>
              <li>
                <a
                  href="#"
                  className="text-white text-center text-[0.975rem] text-style font-medium mb-2 leading-normal md:text-[1rem] md:font-semibold"
                >
                  Sponsor Event
                </a>
              </li>
