...
export const Submit = () => {
  return (
    <div className="mt-6">
       ...
       <div>
            <Button className="rounded-[3.375rem] md:rounded-[3rem] box py-[0.21rem] mx-auto mt-4 md:py-[1.5rem] pl-[1.2rem] md:pl-[2rem] md:pr-[1rem] hover:bg-[#5d8dd9] bg-[#4285F4]  flex items-center gap-2"><span className="text-[0.9375rem] font-bold leading-normal tracking-[-0.025rem]text-style text-[#FFFFFF]">Apply to Volunteer</span> 
